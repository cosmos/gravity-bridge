...
var (
	...
	ErrInvalidEthSymbol       = sdkerrors.Register(ModuleName, 4, "invalid symbol provided, symbol 'eth' must have null address set as token contract address")
	...
	ErrInvalidID              = sdkerrors.Register(ModuleName, 7, "invalid NFT ID")
	ErrInvalidDenom           = sdkerrors.Register(ModuleName, 8, "invalid NFT denom")
	ErrInvalidTokenAddress    = sdkerrors.Register(ModuleName, 9, "invalid NFT address")
)
