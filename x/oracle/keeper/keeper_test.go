...
func TestCreateGetProphecy(t *testing.T) {
	ctx, keeper, _, _, _, _, validatorAddresses := CreateTestKeepers(t, 0.7, []int64{3, 7}, "")
...
func TestBadMsgs(t *testing.T) {
	ctx, keeper, _, _, _, _, validatorAddresses := CreateTestKeepers(t, 0.6, []int64{3, 3}, "")
...
func TestSuccessfulProphecy(t *testing.T) {
	ctx, keeper, _, _, _, _, validatorAddresses := CreateTestKeepers(t, 0.6, []int64{3, 3, 4}, "")
...
func TestPowerAternate(t *testing.T) {
	...
	ctx, keeper, _, _, _, _, validatorAddresses := CreateTestKeepers(t, 0.571, []int64{5, 4, 3, 9}, "")
