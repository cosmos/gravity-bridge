...
func TestFullAppSimulation(t *testing.T) {
	...
	app := NewPeggyApp(logger, db, nil, true, map[int64]bool{}, DefaultNodeHome, FlagPeriodValue, MakeEncodingConfig(), EmptyAppOptions{}, fauxMerkleModeOpt)
...
func TestAppImportExport(t *testing.T) {
	...
	newApp := NewPeggyApp(log.NewNopLogger(), db, nil, true, map[int64]bool{}, DefaultNodeHome, FlagPeriodValue, MakeEncodingConfig(), EmptyAppOptions{}, fauxMerkleModeOpt)
	...
	storeKeysPrefixes := []StoreKeysPrefixes{
		...
		// TODO: Add peggy module once simulation code is write
	}
