...
func InitTestnet(
	...
	for i := 0; i < numValidators; i++ {
		...
		accTokens := sdk.TokensFromConsensusPower(1000, sdk.NewIntFromUint64(10^6))
		accStakingTokens := sdk.TokensFromConsensusPower(500, sdk.NewIntFromUint64(10^6))
		coins := sdk.Coins{
		...
		valTokens := sdk.TokensFromConsensusPower(100, sdk.NewIntFromUint64(10^6))
