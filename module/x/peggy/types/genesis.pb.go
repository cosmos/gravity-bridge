...
type Params struct {
	...
	UnbondSlashingWindow          uint64                                 `protobuf:"varint,17,opt,name=unbond_slashing_window,json=unbondSlashingWindow,proto3" json:"unbond_slashing_window,omitempty"`
}
...
func (m *Params) GetUnbondSlashingWindow() uint64 {
	if m != nil {
		return m.UnbondSlashingWindow
	}
	return 0
}
...
var fileDescriptor_84231c3b3f050761 = []byte{
	...
	,
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.UnbondSlashingWindow != 0 {
		i = encodeVarintGenesis(dAtA, i, uint64(m.UnbondSlashingWindow))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x88
...
func (m *Params) Size() (n int) {
	...
	if m.UnbondSlashingWindow != 0 {
		n += 2 + sovGenesis(uint64(m.UnbondSlashingWindow))
	}
	return n
}
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 17:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field UnbondSlashingWindow", wireType)
			}
			m.UnbondSlashingWindow = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowGenesis
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.UnbondSlashingWindow |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
