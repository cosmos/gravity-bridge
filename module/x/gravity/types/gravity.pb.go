...
import (
	...
	github_com_cosmos_gravity_bridge_module_x_gravity_types "github.com/cosmos/gravity-bridge/module/x/gravity/types"
...
type BatchTx struct {
	...
	Transactions []github_com_cosmos_gravity_bridge_module_x_gravity_types.TxIDs `protobuf:"bytes,3,rep,name=transactions,proto3,casttype=github.com/cosmos/gravity-bridge/module/x/gravity/types.TxIDs" json:"transactions,omitempty"`
...
func (m *BatchTx) GetTransactions() []github_com_cosmos_gravity_bridge_module_x_gravity_types.TxIDs {
	if m != nil {
...
type TransactionIDs struct {
	...
	Ids []github_com_cosmos_gravity_bridge_module_x_gravity_types.TxIDs `protobuf:"bytes,1,rep,name=ids,proto3,casttype=github.com/cosmos/gravity-bridge/module/x/gravity/types.TxIDs" json:"ids,omitempty"`
}
...
func (m *TransactionIDs) GetIds() []github_com_cosmos_gravity_bridge_module_x_gravity_types.TxIDs {
	if m != nil {
		return m.Ids
	}
	return nil
...
var fileDescriptor_1715a041eadeb531 = []byte{
	...
	,
}
