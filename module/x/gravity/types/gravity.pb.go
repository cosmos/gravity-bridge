...
type BatchTxInfo struct {
	...
	// batch tx identifier
	ID github_com_tendermint_tendermint_libs_bytes.HexBytes `protobuf:"bytes,2,opt,name=id,proto3,casttype=github.com/tendermint/tendermint/libs/bytes.HexBytes" json:"id,omitempty"`
}

func (m *BatchTxInfo) Reset()         { *m = BatchTxInfo{} }
func (m *BatchTxInfo) String() string { return proto.CompactTextString(m) }
func (*BatchTxInfo) ProtoMessage()    {}
func (*BatchTxInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_1715a041eadeb531, []int{8}
}
func (m *BatchTxInfo) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *BatchTxInfo) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_BatchTxInfo.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *BatchTxInfo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BatchTxInfo.Merge(m, src)
}
func (m *BatchTxInfo) XXX_Size() int {
	return m.Size()
}
func (m *BatchTxInfo) XXX_DiscardUnknown() {
	xxx_messageInfo_BatchTxInfo.DiscardUnknown(m)
}

var xxx_messageInfo_BatchTxInfo proto.InternalMessageInfo

func (m *BatchTxInfo) GetTokenContract() string {
	if m != nil {
		return m.TokenContract
	}
	return ""
...
func (m *BatchTxInfo) GetID() github_com_tendermint_tendermint_libs_bytes.HexBytes {
	if m != nil {
		return m.ID
	}
	return nil
...
func (*TransactionIDs) Descriptor() ([]byte, []int) {
	return fileDescriptor_1715a041eadeb531, []int{12}
}
...
func init() {
	...
	proto.RegisterType((*BatchTxInfo)(nil), "gravity.v1.BatchTxInfo")
...
var fileDescriptor_1715a041eadeb531 = []byte{
	...
	,
}
...
func (m *BatchTxInfo) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *BatchTxInfo) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *BatchTxInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.ID) > 0 {
		i -= len(m.ID)
		copy(dAtA[i:], m.ID)
		i = encodeVarintGravity(dAtA, i, uint64(len(m.ID)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.TokenContract) > 0 {
...
func (m *BatchTxInfo) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BatchTxInfo: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BatchTxInfo: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
