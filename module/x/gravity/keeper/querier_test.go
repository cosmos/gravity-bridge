...
func TestQueryValsetConfirm(t *testing.T) {
	...
	ctx := input.Context
	input.GravityKeeper.SetValsetConfirm(ctx, types.ValsetConfirm{
		Nonce:               nonce,
		OrchestratorAddress: myValidatorCosmosAddr.String(),
...
func TestAllValsetConfirmsBynonce(t *testing.T) {
	...
	for i := 0; i < 3; i++ {
		...
		msg.Nonce = uint64(1)
		msg.OrchestratorAddress = addr.String()
...
func TestQueryAllBatchConfirms(t *testing.T) {
	...
	input.GravityKeeper.SetBatchConfirm(ctx, &types.ConfirmBatch{
		Nonce:               1,
		TokenContract:       tokenContract,
		EthSigner:           "0xf35e2cc8e6523d683ed44870f5b7cc785051a77d",
		OrchestratorAddress: validatorAddr.String(),
		Signature:           "signature",
	})
...
func TestQueryLogicCallsConfirms(t *testing.T) {
	...
	confirm := types.ConfirmLogicCall{
		...
		InvalidationNonce:   1,
		EthSigner:           "test",
		OrchestratorAddress: valAddr.String(),
		Signature:           "test",
	}
