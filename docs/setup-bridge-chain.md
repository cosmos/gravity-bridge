...
# ebcli tx ethbridge create-claim [ethereum-chain-id] [bridge-registry-contract] [nonce] [symbol] [token-contract] [ethereum-sender-address] [cosmos-receiver-address] [validator-address] [amount] [claim-type] [flags]",
ebcli tx ethbridge create-claim 3 0x30753E4A8aad7F8597332E813735Def5dD395028 0 eth 0x0000000000000000000000000000000000000000 0x11111111262b236c9ac9a9a8c8e4276b5cf6b2c9 $(ebcli keys show testuser -a) $(ebcli keys show validator -a --bech val) 3eth lock --from=validator --yes
...
# ebcli query ethbridge prophecy [ethereum-chain-id] [bridge-registry-contract] [nonce] [symbol] [token-contract] [ethereum-sender] [flags]
ebcli query ethbridge prophecy 3 0x30753E4A8aad7F8597332E813735Def5dD395028 0 eth 0x0000000000000000000000000000000000000000 0x11111111262b236c9ac9a9a8c8e4276b5cf6b2c9
...
# ebcli tx ethbridge create-claim [ethereum-chain-id] [bridge-registry-contract] [nonce] [symbol] [token-contract] [ethereum-sender-address] [cosmos-receiver-address] [validator-address] [amount] [claim-type] [flags]
ebcli tx ethbridge create-claim 3 0x30753E4A8aad7F8597332E813735Def5dD395028 1 stake 0x345cA3e014Aaf5dcA488057592ee47305D9B3e10 0x11111111262b236c9ac9a9a8c8e4276b5cf6b2c9 $(ebcli keys show testuser -a) $(ebcli keys show validator -a --bech val) 1stake burn --from=validator --yes

# Then read the prophecy to confirm it was created with the claim added
# ebcli query ethbridge prophecy [ethereum-chain-id] [bridge-registry-contract] [nonce] [symbol] [token-contract] [ethereum-sender] [flags]
ebcli query ethbridge prophecy 3 0x30753E4A8aad7F8597332E813735Def5dD395028 1 stake 0x345cA3e014Aaf5dcA488057592ee47305D9B3e10 0x11111111262b236c9ac9a9a8c8e4276b5cf6b2c9
