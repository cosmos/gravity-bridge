module.exports = async () => {
  ...
  const tokenContract = truffleContract(require('../build/contracts/BridgeToken.json'));
  ...
  try {
    ...
    if (coinDenom != 'eth') {
      const bridgeContractAddress = await contract.deployed().then(function (instance) {
